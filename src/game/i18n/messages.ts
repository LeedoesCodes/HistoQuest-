...
export const MESSAGES = {
  ...
  "mg.mactan.sub": {
    fil: "Pindutin ang mga kawal para itaboy sila! Bantayan ang may baril (pula).",
    en: "Tap the soldiers to drive them back! Watch the ones with guns (red).",
  },
  "mg.mactan.morale": { fil: "Lakas ng Bayan", en: "People's Strength" },
